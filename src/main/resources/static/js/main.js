    ...
    $("form[name='add-pet']").validate({
        ...
        messages: {
            breed: {
                ...
                minlength: "Your breed must be at least 3 characters long",
                maxlength: "Your breed must be at no more than 10 characters long"
            },
            name: {
                required: "Please enter your name.",
                minlength: "Your name must be at least 3 characters long",
                maxlength: "Your name must be at no more than 10 characters long"
            },
            age: {
